...
\begin{align}
 &\norm{\vec{R}-\vec{E}}=c \label{eq5}
 \\
  &\norm{\vec{M}-\vec{E}} =d \label{eq6}
\end{align}  
...
\end{align}
 \begin{align}
 \vec{E}= \vec{M}+ \abs{\lambda}\times \myvec{cos\theta\\sin\theta}
 \end{align}
 \end{lemma}
 \begin{proof}
 \begin{itemize}
 ...
 \begin{align}
\implies \vec{R}= \vec{O}+\abs{\lambda}\times \myvec{cos75\degree\\sin75\degree}
 \end{align}
  \begin{align}
