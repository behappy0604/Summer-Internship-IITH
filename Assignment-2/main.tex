...
\end{align}
 ...
 \begin{align}
\implies \vec{R}= \vec{O}+\abs{b}\times \myvec{\cos75\degree\\\sin75\degree}
 \end{align}
  \begin{align}
     \implies  \vec{R}-\vec{O}= b \times \myvec{\cos75\degree\\\sin75\degree}
 \end{align}
 \begin{align}
    \implies {\norm{\vec{R}-\vec{O}}}= \abs{b} \times{\norm{\myvec{\cos75\degree\\\sin75\degree}}}
\end{align}
\begin{align}
   \implies 4.5= \abs{b} \times 1
\end{align}
\begin{align}
    \implies b = 4.5 
\end{align}
...
\begin{itemize}
 ...
 The vector equation of a line can be given by as,
  \begin{align}
     \implies  \vec{E}-\vec{M}= d \times \myvec{\cos60\degree\\\sin60\degree}
 \end{align}
 \begin{align}
    \implies {\norm{\vec{E}-\vec{M}}}= \abs{d} \times{\norm{\myvec{0.50\\0.87}}}
\end{align}
\begin{align}
   \implies 7.34= \abs{d} \times 1
\end{align}
\begin{align}
    \implies d = 7.34
\end{align}
