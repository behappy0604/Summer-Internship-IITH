...
\begin{align}
   X=3V-2U 
\end{align}
 \\where $X$ is also a normal random variable with mean given as $\mathbb{E}[X]$:
 \begin{align}
...
\begin{align}
    var(X)= \mathbb{E}[(3V-2U)^2]-(3\mathbb{E}[V]-2\mathbb{E}[U])^2
\end{align}
\begin{multline}
 var(X)= \mathbb{E}[9V^2+4U^2-12UV]-9\mathbb{E}[V]^2\\-4\mathbb{E}[U]^2+12\mathbb{E}[V]\mathbb{E}[U] 
\end{multline}
\begin{multline}
 var(X)= 9\mathbb{E}[V^2]+4\mathbb{E}[U^2]-12\mathbb{E}[UV]-9\mathbb{E}[V]^2\\-4\mathbb{E}[U]^2+12\mathbb{E}[V]\mathbb{E}[U]
\end{multline}
\begin{multline}
 var(X)= 9(\mathbb{E}[V^2]-\mathbb{E}[V]^2)+4(\mathbb{E}[U^2]-\mathbb{E}[U]^2)\\-12\mathbb{E}[UV]-\mathbb{E}[U]\mathbb{E}[V])
\end{multline}
\begin{align}
